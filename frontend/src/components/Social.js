	...
	async function displayRazorpay() {
		...
		const options = {
			...
			handler: function (response) {
                ...
                history.push('/exam/Social/instructions')
			},
			prefill: {
				name
			}
                                    ...
                                    <div className="col-md-12">
                                        <div className="about-info">
                                            ...
                                            <div className="media mt-3">
                                                <img src={social} className="mr-3" alt="..."></img>
                                                <div className="media-body">
                                                    <ul>
                                                        <li>
                                                            <span className="title-span">Exam Name : </span>
                                                            <span className="info-span" style={{color:"rgb(77,77,77)"}}>Social Studies Test</span>
                                                        </li>
                                                        <li>
                                                            <span className="title-span">Examiner Name:</span>
                                                            <span className="info-span" style={{color:"rgb(77,77,77)"}}>Genevieve</span>
                                                        </li>
                                                        <li>
                                                            <span className="title-span">Course: </span>
                                                            <span className="info-span" style={{color:"rgb(77,77,77)"}}>Social Studies</span>
                                                        </li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <span className="info-span" style={{color:"rgb(77,77,77)"}}>This quiz tests the basics of your Social knowldge</span>
                                                        </li>
                                                        <br></br>
