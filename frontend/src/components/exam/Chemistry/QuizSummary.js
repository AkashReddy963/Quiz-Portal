            ...
            stats = (
                <Fragment>
                    ...
                    <div className="container">
                        ...
                        <span className="stat left">Total number of unattempted/wrong answers:</span>
                    ...
                    <section className="links">
                        <ul>
                            <li>
                                ...
                                <Link to="/exam/Chemistry/quiz" className="button-link-pa">Do quiz again?</Link>
                            </li>
                        </ul>
                    </section>
                </Fragment>
            ...
            stats = (
                <section>
                    ...
                    <ul>
                        ...
                        <li>
                            <Link to="/exam/Chemistry/quiz">Start Quiz?</Link>
                        </li>
                    </ul>
                </section>
            );
