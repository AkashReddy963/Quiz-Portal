...
import one from '../../assets/img/Social/q1.jpg';
import two from '../../assets/img/Social/q2.jpg';
import three from '../../assets/img/Social/q3.jpg';
import four from '../../assets/img/Social/q4.jpg';
import five from '../../assets/img/Social/q5.jpg';


import questions from '../../Questions/Social.json';
...
export class Quiz extends Component {
    ...
    endGame = () => {
     /*   alert("Game has ended.");*/
        ...
        setTimeout(() => {
            this.props.history.push('/exam/Social/QuizSummary', playerStats);
        }, 1000);
    };
    render() {
