        ...
        if(state !== undefined) {
            stats = (
                <Fragment>
                    ...
                    <section className="links">
                        <ul>
                            <li>
                                <Link to="/" className="button-link-bth">End Quiz / Back to home?</Link>
                                <Link to="/quiz/Quiz" className="button-link-pa">Do quiz again?</Link>
                            </li>
                        </ul>
                    </section>
                </Fragment>
            ...
            stats = (
                <section>
                    ...
                    <ul>
                        <li>
                            <Link to="/">End Quiz/ Back to home?</Link>
                        </li>
                        <li>
                            <Link to="/quiz/quiz">Start Quiz?</Link>
                        </li>
                    </ul>
                </section>
            );
