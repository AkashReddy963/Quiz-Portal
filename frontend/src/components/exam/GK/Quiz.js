...
import one from '../../assets/img/GK/q1.jpg';
import two from '../../assets/img/GK/q2.jpg';
import three from '../../assets/img/GK/q3.jpg';
import four from '../../assets/img/GK/q4.jpg';
import five from '../../assets/img/GK/q5.jpg';


import questions from '../../Questions/GK.json';
...
export class Quiz extends Component {
    ...
    endGame = () => {
     /*   alert("Game has ended.");*/
        ...
        setTimeout(() => {
            this.props.history.push('/exam/GK/QuizSummary', playerStats);
        }, 1000);
    };
    render() {
