	...
	async function displayRazorpay() {
		...
		const options = {
			...
			handler: function (response) {
                ...
                history.push('/exam/Chemistry/instructions')
			},
			prefill: {
				name
			}
                                    ...
                                    <div className="col-md-12">
                                        <div className="about-info">
                                            ...
                                            <div className="media mt-3">
                                                <img src={chemistry} className="mr-3" alt="..."></img>
                                                <div className="media-body">
                                                    <ul>
                                                        <li>
                                                            <span className="title-span">Exam Name : </span>
                                                            <span className="info-span" style={{color:"rgb(77,77,77)"}}>Chemistry Test</span>
                                                        </li>
                                                        <li>
                                                            <span className="title-span">Examiner Name:</span>
                                                            <span className="info-span" style={{color:"rgb(77,77,77)"}}>Lara Jean</span>
                                                        </li>
                                                        <li>
                                                            <span className="title-span">Course: </span>
                                                            <span className="info-span" style={{color:"rgb(77,77,77)"}}>Chemistry</span>
                                                        </li>
                                                        ...
                                                        <li>
                                                            ...
                                                            <span className="info-span" style={{color:"rgb(77,77,77)"}}>This quiz tests the basics of your Chemistry skills</span>
                                                        </li>
                                                        <br></br>
